...
$sth = $connection->prepare("INSERT INTO `students`
 (f_name, l_name, dob, e_mail, number, country) VALUES 
 (:db_first_name, :db_last_name, :db_dob, :db_email,
  :db_mobile_no, :db_country)"); 
